...
private List<Issues> cards;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.issuesRecycle);
        cards = new ArrayList<>();
        JuneBugCardAdapter adapter = new JuneBugCardAdapter(this,cards);

        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(this,1);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.addItemDecoration(new juneBug.GridSpacingItemDecoration(1, dpToPx(10), true));
...
Issues a = new Issues(TITLE, DESCRIPTION,STATUS,PROJECT,AUTHOR, DAYS);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.june_bug, menu);
        return true;
    }
